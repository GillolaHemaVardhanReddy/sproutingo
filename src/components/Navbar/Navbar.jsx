...
import logo from "../../assests/Card_2_page-0001-removebg-preview.png"
import "./Navbar.css"
        ...
        <div className="navbar">
            ...
            <div className="right">
                ...
                <div className="cart text">
                    <svg xmlns="http://www.w3.org/2000/svg" width="2.5rem" height="2.5rem" fill="currentColor" class="bi bi-bag-heart" viewBox="0 0 16 16">
